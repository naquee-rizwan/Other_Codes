...
// Here you have to get the maximum total profit by smaller than or equal to knapsack weight 'W' required to be achieved where the values for weight and the corresponding profits are given.
// Note- It is given here that you have to calculate the maximum total profit by using smaller than or equal to that knapsack weight 'W'.
#include<bits/stdc++.h>
using namespace std;
int main()
{
